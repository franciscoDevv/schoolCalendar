...
let events = [
  { date: "2024-06-04", description: "Fotovoz", fullDescription: "Los estudiantes de forma individual deberán realizar una página webque posea su autobiografía de sus días a través del método FotoVoz, es importante que para realizar dicha actividad los estudiantes posean 8 fotos distribuidas en 2 días. Para ello deberán utilizar HTML, CSS y JavaScript, además deberán utilizar Bootstrap para la creación de dicha página, por otra parte debe contar con un menú que permita movernos entre los dos días, idealmente usar una letra distinta a las que entrega el sistema.", tipo: "trabajo", link: "https://classroom.google.com/u/1/c/NjU5NTU4NDMwODc5/a/NjgzNTA4NjE2NjA1/details", subject: "Diseño de Prototipos Web"},
  ...
  { date: "2024-06-07", description: "Prueba Ciencias para la Ciudadanía", fullDescription: "Prueba Semestral de Ciencias para la Ciudadanía", tipo: "prueba", subject: "Ciencias para la Ciudadanía"},
